...
#pragma vector aligned
          ...
          { 
            Z[ib0+0] = _mm512_mul_pd(_a,_x[ib0+0]);
            Z[ib0+1] = _mm512_mul_pd(_a,_x[ib0+1]);
            Z[ib0+2] = _mm512_mul_pd(_a,_x[ib0+2]);
            Z[ib0+3] = _mm512_mul_pd(_a,_x[ib0+3]);
            Z[ib0+4] = _mm512_mul_pd(_a,_x[ib0+4]);
            Z[ib0+5] = _mm512_mul_pd(_a,_x[ib0+5]);
            Z[ib0+6] = _mm512_mul_pd(_a,_x[ib0+6]);
            Z[ib0+7] = _mm512_mul_pd(_a,_x[ib0+7]);
